...
public class AdminProductController {
    ...
    @PostMapping("/create")
    public String createContent(@RequestParam("name") String name, @RequestParam("description") String description, @RequestParam("price") int price, MultipartFile thumbnail) {
